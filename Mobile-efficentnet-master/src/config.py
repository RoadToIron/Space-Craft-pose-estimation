...
class Config:
    def __init__(self, device):
        ...
        self.BATCH_SIZE = 32
        self.DATASET = 'SPEED'
        self.DATASET_PATH = "C:/Users/Mama/Desktop/projtake3/datasets/speed"
        ...
        self.MODEL_PATH = "C:/Users/Mama/Desktop/projtake3/Mobile-URSONet-master/models/exp.pt"
        ...
        self.ORI_TYPE = 'Regression'  # 'Classification' or 'Regression'
        self.POS_TYPE = 'Regression'  # Only regression implemented

        # ORI soft classification parameters
        self.N_ORI_BINS_PER_DIM = 16 #changed this orig value is 16
